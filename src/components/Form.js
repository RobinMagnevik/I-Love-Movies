...
const Form = () => {
	...
	const handleSubmit = e => {
		e.preventDefault();
		if(movie.genre) {
			setMovie({ ...movie, title: ""}, { ...movie, description: ""}, { ...movie, genre: ""}, {...movie, year: ''}, {...movie, ofType: ''})
		}
	...
	return (
		...
		<form className="addFavoriteToListForm" onSubmit={handleSubmit}>
			...
			<div>
				...
				<input checked={true} value="movie" type="radio" name="ofType" id="Movie" onChange={handleChange}/>
				<label htmlFor="Serie">Serie: </label>
				<input value="serie" type="radio" name="ofType" id="Serie" onChange={handleChange}/>
			</div>
			</div>
